    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow border border-gray-300">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                {attemptResultDetail?.status === 'COMPLETED' && (
                    <div className="flex gap-2">
                        <button
                            onClick={onReviewRequest}
                            className="bg-blue-500 text-white text-sm md:text-md font-medium md:font-bold md:px-4 md:py-2 rounded-lg hover:bg-blue-600"
                        >
                            Request Review
                        </button>
                    </div>
