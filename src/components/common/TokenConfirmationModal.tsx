            ...
            <div className="bg-white p-8 rounded-lg backdrop-blur-sm shadow-xl max-w-sm mx-auto border border-teal-200/50">
                ...
                {exam && (
                    <p className="text-red-500 mb-6">
                        This test, "{exam.title}", costs {exam.tokenCost.toLocaleString('vi-VN')} ₫. Do you want to continue?
                    </p>
                )}
                {combinedExam && (
                    <p className="text-red-500 mb-6">
                        This combined test costs {combinedExam.totalCost.toLocaleString('vi-VN')} ₫. Do you want to continue?
                    </p>
                )}
