...
const FlashcardCreatePage: React.FC = () => {
    ...
    const { createFlashcardSet, loading, uploadImage, uploadingImage } = useFlashcardSets();
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <p className="text-center text-gray-400 text-sm mt-4">
                    {cards.length} cards • Need at least 2 cards to create set
                </p>
            </div>
                ...
                {activeTab === "search" ? (
                    ...
                    <div className="py-8">
                        <input
                            ...
                            className="hidden"
                            id="flashcard-image-upload"
                        />
                        <label
                            htmlFor="flashcard-image-upload"
